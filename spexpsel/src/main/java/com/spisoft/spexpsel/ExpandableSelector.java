...
import com.spisoft.spexpsel.animation.ExpandableSelectorAnimator;
...
public class ExpandableSelector extends FrameLayout {
  ...
  private View initializeButton(int expandableItemPosition) {
    ...
    if (expandableItem.hasTitle()) {
      ...
      if(expandableItem.hasDisable())
        button = layoutInflater.inflate(R.layout.expandable_item_button_disable, this, false);
    } else {
