...
package com.spisoft.spexpselector;
...
import com.spisoft.spexpsel.ExpandableItem;
import com.spisoft.spexpsel.ExpandableSelector;
import com.spisoft.spexpsel.ExpandableSelectorListener;
import com.spisoft.spexpsel.OnExpandableItemClickListener;
...
public class MainActivity extends AppCompatActivity {
  ...
  private void initializeSizesExpandableSelector() {
    ...
    List<ExpandableItem> expandableItems = new ArrayList<ExpandableItem>();
    expandableItems.add(new ExpandableItem("XL", false));
    expandableItems.add(new ExpandableItem("L", true));
    expandableItems.add(new ExpandableItem("M1", false));
    expandableItems.add(new ExpandableItem("M2", false));
    expandableItems.add(new ExpandableItem("M3", false));
    expandableItems.add(new ExpandableItem("M4", false));
    expandableItems.add(new ExpandableItem("M5", false));
    expandableItems.add(new ExpandableItem("M6", false));
    expandableItems.add(new ExpandableItem("M7", false));
    expandableItems.add(new ExpandableItem("M8", false));
    expandableItems.add(new ExpandableItem("M9", false));
    expandableItems.add(new ExpandableItem("S", true));
